...
public class Chapitre2CoreJava2 {
    ...
    public static List<String> listeDesMots() {
        List<String> liste = new LinkedList<>(); // à  compléter
    ...
    public static Map<String, Integer> occurrencesDesMots(List<String> liste) {
        ...
        Integer currentOccurence;
        for(String element : liste){
            currentOccurence = table.putIfAbsent(element, 1);
            if(currentOccurence != null)
                table.replace(element, currentOccurence + 1);
        }
        return table;
    }
